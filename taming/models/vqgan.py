...
class VQSegmentationModel(VQModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        xrec, qloss = self(x)
        aeloss, log_dict_ae = self.loss(qloss, y, xrec, split="train")
        self.log_dict(log_dict_ae, prog_bar=False, logger=True, on_step=True, on_epoch=True)
        return aeloss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        y = self.get_input(batch, 'image')
        xrec, qloss = self(x)
        aeloss, log_dict_ae = self.loss(qloss, y, xrec, split="val")
        self.log_dict(log_dict_ae, prog_bar=False, logger=True, on_step=True, on_epoch=True)
...
class VQNoDiscModel(VQModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        xrec, qloss = self(x)
        # autoencode
        aeloss, log_dict_ae = self.loss(qloss, y, xrec, self.global_step, split="train")
    ...
    def validation_step(self, batch, batch_idx):
        ...
        y = self.get_input(batch, 'image')
        xrec, qloss = self(x)
        aeloss, log_dict_ae = self.loss(qloss, y, xrec, self.global_step, split="val")
        rec_loss = log_dict_ae["val/rec_loss"]
